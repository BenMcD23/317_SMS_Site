  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="min-w-0">
        <header className="no-print sticky top-0 z-20 flex h-14 shrink-0 items-center gap-2 border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/80">
