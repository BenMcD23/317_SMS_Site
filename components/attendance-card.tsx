        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
              ...
              <Stat label="Last attended" value={lastAttended ? formatDate(lastAttended) : "—"} />
            </div>
              ...
              <>
                    ...
                    <TableBody>
                      {filtered.slice(0, ROW_LIMIT).map((record) => (
                        <TableRow key={record.id}>
                          ...
                          <TableCell>
                            <Badge variant="outline" className={cn("font-normal", STATE_BADGE[record.state])}>
                ...
                {filtered.length > ROW_LIMIT && (
                  <p className="text-muted-foreground text-xs">
                    Showing the {ROW_LIMIT} most recent of {filtered.length} records — narrow the dates to see
                    older ones. The stats above cover the whole range.
                  </p>
                )}
              </>
            )}
