...
function ScoreSelector({
  ...
  return (
    <div className="bg-card rounded-lg border p-4 transition-shadow hover:shadow-sm">
      <div className="mb-3 flex items-start gap-3">
        ...
        <p className="text-sm leading-snug font-medium">{question.text}</p>
      </div>
...
export default function LeadershipAssessmentPage() {
  ...
  const {
    ...
    clearDraft,
    draftRestored,
  } = useAssessmentDraft("leadership", initialState(), session?.user?.email, (s) => s.cadetCin !== null);
        ...
        <>
          ...
          <div className="bg-card flex items-center gap-4 rounded-lg border p-4">
            <div className="flex-1">
              <div className="mb-1.5 flex items-center justify-between text-sm">
                ...
                {allAnswered && <span className="font-mono font-semibold">Score: {totalScore} / 50</span>}
              </div>
          ...
          {allAnswered && (
            ...
            >
              {passed ? (
                <p>
                  <strong>PASS</strong> — Score of <strong>{totalScore}/50</strong>, no scores of 1. Cadet has
                  achieved the Blue Badge leadership standard.
                </p>
              ) : (
                <p>
            ...
            <CardContent>
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, debriefingNotes: e.target.value.slice(0, DEBRIEF_MAX) }))
                  }
                />
              </div>
            </CardContent>
